...
struct AnomalyDetectorUtil {
    ...
    create_approx_sma(u32 N, u32 K, double threshold, u32 window_size);
    ...
    static std::unique_ptr<AnomalyDetectorIface> create_approx_ewma(u32 N, u32 K,
    ...
    static std::unique_ptr<AnomalyDetectorIface>
    create_approx_double_exp_smoothing(u32 N, u32 K, double threshold, double alpha,
                                       double beta);
